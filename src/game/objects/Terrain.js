...
export default class Terrain {
    ...
    async build() {
        var texture = TextureLoader.load(assets.terrain.texture);
        ...
        var mapHeight = new THREE.TextureLoader().load(assets.terrain.normalMap);
        ...
        this.rocks = Rocks.buildRocks(this);
    }
